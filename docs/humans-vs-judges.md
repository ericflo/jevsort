...
Pages app in [`docs/`](https://github.com/ericflo/jevsort/tree/main/docs), no build step) shows you 8 pairs of anonymized summaries, one question at a time
...
[`human-ballot`](https://github.com/ericflo/jevsort/blob/main/.github/ISSUE_TEMPLATE/human-ballot.yml) template (zero backend). The page also has a pluggable
`submit_endpoint` in [`docs/config.js`](https://github.com/ericflo/jevsort/blob/main/docs/config.js) for a Worker/Supabase collector. Ballots become the
...
← [Evaluation](evaluation.md) · [Summary Showdown](https://ericflo.github.io/jevsort/) → · [All docs](guide.md)
